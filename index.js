...
var ASM_CONSTS = {
 ...
 378530: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 378613: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 378682: () => { return window.innerWidth; },  
 378712: () => { return window.innerHeight; }
};
